...
**バージョン**: 1.2.0 (2025-08-04)  
**ステータス**: 🏆 **エンタープライズ対応完了 - 健全性スコア 100/100**  
**品質達成**: ✅ **完璧スコア達成**  
...
2. **ビルド済みModをダウンロード**: `minecraft-collaboration-mod-1.0.0.jar`
3. **Modを`.minecraft/mods/`フォルダに配置**
4. **Scratch GUIにアクセス**: 
   - ローカル: `scratch-gui-minecraft-loader.html`を開く
   - オンライン: デプロイされたURLにアクセス
5. **拡張機能から「Minecraft コラボレーション」を選択**
