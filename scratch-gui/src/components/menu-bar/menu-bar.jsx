...
import RecordButton from '../record-button/record-button.jsx';
        ...
        return (
            ...
            >
                <div className={styles.mainMenu}>
                    ...
                    <div className={classNames(styles.menuBarItem)}>
                        <Button
                            className={classNames(styles.menuBarButton, styles.minecraftButton)}
                            iconClassName={styles.minecraftIcon}
                            onClick={this.props.onClickMinecraft}
                        >
                            <div className={styles.menuBarButtonContent}>
                                ...
                                <span className={styles.minecraftText}>
                                    <FormattedMessage
                                        ...
                                        description="Minecraft connection button"
                                        id="gui.menuBar.minecraft"
                                    />
                                </span>
                            </div>
                        </Button>
                    ...
                    <div className={classNames(styles.menuBarItem)}>
                        <RecordButton
                            className={classNames(styles.menuBarButton, styles.recordButton)}
                            recording={this.props.recording}
                            onClick={this.props.onRecordClick}
                            title={this.props.recording ? 'Stop Recording' : 'Start Recording'}
                        />
                    </div>
...
MenuBar.propTypes = {
    ...
    onClickMinecraft: PropTypes.func,
