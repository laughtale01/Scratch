...
import edu.minecraft.collaboration.security.threat.UserActivityEvent;
import edu.minecraft.collaboration.security.threat.ThreatAssessment;
import edu.minecraft.collaboration.security.threat.ThreatLevel;
...
public class FullSystemIntegrationTest {
    ...
    void testWebSocketMessageProcessing() throws Exception {
        ...
        String connectionId = "test_connection_id";
        webSocketHandler.sendMessage(connectionId, testMessage);
    ...
    void testCompleteCommandExecutionFlow() throws Exception {
        ...
        // Test invite command
        String[] inviteArgs = new String[]{"other_player"};
        String inviteResult = commandHandler.handleCommand("invitefriend", inviteArgs);
        assertNotNull(inviteResult);
        
        // Test accept command  
        String[] acceptArgs = new String[]{"test_invite_id"};
        String acceptResult = commandHandler.handleCommand("approvevisit", acceptArgs);
