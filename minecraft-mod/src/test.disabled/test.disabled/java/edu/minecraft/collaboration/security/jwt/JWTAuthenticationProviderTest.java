...
public class JWTAuthenticationProviderTest {
    ...
    void testRefreshToken() {
        ...
        // When
        JWTAuthenticationProvider.JWTTokenPair newPair = 
            jwtProvider.refreshToken(originalPair.getRefreshToken());
    ...
    void testTokenClaimsValidation() {
        ...
        assertEquals("Test School", result.getUser().getClaims().get("school", String.class));
        assertEquals("10", result.getUser().getClaims().get("grade", String.class));
    }
