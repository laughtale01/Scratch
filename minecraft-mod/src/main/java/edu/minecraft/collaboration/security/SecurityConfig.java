...
public class SecurityConfig {
    ...
    // Blocked commands - expanded for educational safety
    private static final Set<String> BLOCKED_COMMANDS = new HashSet<>(Arrays.asList(
        ...
        "reload",
        "restart",
        "execute",  // Can be used for command injection
        "function", // Can execute functions
        "trigger",  // Can trigger functions
        "publish",  // Opens server to LAN
        "debug",    // Debug commands
        "worldborder", // Can break world
        "setworldspawn",
        "defaultgamemode",
        "gamerule"  // Can change game rules
    ));
