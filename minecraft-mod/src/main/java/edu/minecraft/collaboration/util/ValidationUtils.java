...
public class ValidationUtils {
    ...
    public static boolean isValidBlockType(String blockType) {
        ...
        String[] validBlocks = {
            ...
            "water", "lava", "oak_log", "oak_leaves", "glass", "coal_ore", "iron_ore",
            "gold_ore", "diamond_ore", "redstone_ore", "brick", "tnt", "bookshelf",
            "mossy_cobblestone", "obsidian", "torch", "chest", "crafting_table", "furnace",
            "ladder", "redstone_wire", "redstone_torch", "lever", "stone_button",
